...
- Many SocketLabs methods contain Polis24-specific copy and a hard-coded `dummy@example.com` recipient in `sendEmailPostSegnalato` — replace before any non-Polis24 use.
